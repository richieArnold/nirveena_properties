...
//         // delete configuration
//         await pool.query(`DELETE FROM project_configurations WHERE id = $1`, [
//           id,
//         ]);
...
//         await client.query(`DELETE FROM project_floor_plans WHERE id = $1`, [
//           id,
//         ]);
