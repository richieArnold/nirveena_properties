        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1">
              Total: {totalCount} projects | Sorted by: {sortBy === 'display_order' ? 'Display Order' : sortBy === 'project_id' ? 'Project ID' : 'Project Name'} ({sortOrder})
            </p>
          </div>
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-lg transition flex items-center gap-2 text-sm ${
                showSortPanel ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-end">
              <div className="flex-1">
                ...
                >
                  ...
                  <option value="project_name">Project Name (Alphabetical)</option>
                </select>
              </div>
                ...
                <div key={project.id} className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                      <p className="text-xs text-gray-500 mb-2">Display Order</p>
                      <div className="flex items-center gap-2">
                        <input
                          type="number"
                          min="0"
