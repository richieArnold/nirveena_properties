...
const ContactPage = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email Us",
      details: ["info@nirveenaproperty.com", "sales@nirveenaproperty.com"],
    ...
    },
    {
      ...
      details: ["Prestige Tech Park", "Bangalore, Karnataka", "India - 560048"],
    ...
    },
    {
      ...
      details: ["Quick Query Resolution", "Property Consultation", "After Sales Service"],
  ...
  const faqs = [
    {
      ...
      answer: "We respond to all inquiries within 4 hours during business days. For urgent matters, call our 24/7 support line."
    },
    {
      question: "Do you offer virtual property tours?",
      answer: "Yes, we provide high-quality virtual tours for all our listed properties. Contact us to schedule one."
    },
    {
      question: "What areas do you cover?",
      answer: "We specialize in Bangalore properties but also handle premium properties across major Indian cities."
    },
    {
      question: "Is there any consultation fee?",
      answer: "No, our initial consultation is completely free. We only charge upon successful transaction completion."
    }
  ];
      ...
      <section className="relative py-20 md:py-28 overflow-hidden bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Have questions about properties? Our expert team is here to help you find your dream home.
              Reach out anytime!
            </motion.p>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="80-100">80L-1 Cr</option>
              ...
              >
                ...
                <div className="mt-6 p-4 bg-white/10 rounded-xl">
                  <p className="text-sm text-white/90">
                    <span className="font-bold">Note:</span> For urgent inquiries outside business hours, 
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Visit us at our main office for personalized property consultations
            </p>
          </motion.div>
              ...
              <div className="p-8 lg:p-10">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Nirveena Property Headquarters</p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">office@nirveenaproperty.com</p>
                    </div>
                  </div>
                </div>
                
                <div className="mt-8 pt-8 border-t border-gray-100">
                  <h4 className="font-bold text-gray-900 mb-3">Parking Information</h4>
                  <p className="text-gray-600">
                    Ample parking available in the building basement. 
                    Visitor parking on Level P2.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:col-span-2 relative min-h-[350px]">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h4 className="text-2xl font-bold text-gray-900 mb-2">Office Location</h4>
                    <p className="text-gray-600 max-w-xs mx-auto">
                      Prestige Tech Park, Bangalore
                    </p>
                    <button className="mt-6 px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium hover:shadow-lg transition-shadow">
                      Get Directions
                    </button>
                  </div>
                </div>
