                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className={`w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3.5 rounded-lg font-bold shadow-lg hover:shadow-xl transition-all duration-300 ${isSubmitting ? "opacity-80 cursor-not-allowed" : ""
                        }`}
                    >
                      {isSubmitting ? (
          ...
          >
            <div className="grid lg:grid-cols-3">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        3rd floor, Barathi Nagaraj Plaza,681,
                        <br /> Ramagondanahalli, Whitefield, <br />
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+91 9900468686</p>
                    </div>
                  </div>
              ...
              <div className="lg:col-span-2 relative min-h-[400px]">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8363.54551779448!2d77.73250064287073!3d12.963059549405896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae0d257d210365%3A0xa6e0de4dd0d9f159!2sNirveena%20Realty%20Pvt%20Ltd!5e1!3m2!1sen!2sin!4v1785246403433!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
              </div>
            </div>
          </motion.div>
        </div>
