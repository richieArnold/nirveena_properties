...
function PropertiesHero() {
  return (
    <>
      {/* ✅ HERO SECTION */}
      <section className="relative h-[500px] flex items-center overflow-hidden text-white">
        {/* Background Image */}
        <img
        ...
        <div className="relative z-10 w-full px-6">
          ...
          {/* Subtext */}
          <p className="text-sm md:text-base font-semibold uppercase tracking-[0.15em] text-gray-300 max-w-xl">
